...
class _PokeListWidgetState extends State<PokeListWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      while (_model.pokemonIndex < 250) {
        _model.apiResultPk = await PokeApiGroup.pokemonCall.call(
          pokemonId: _model.pokemonIndex,
        );
        if ((_model.apiResultPk?.succeeded ?? true)) {
          setState(() {
            _model.pokemonIndex = _model.pokemonIndex + 1;
            _model.addToPokeList(PokemonStruct.maybeFromMap(
                (_model.apiResultPk?.jsonBody ?? ''))!);
          });
        } else {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(
                (_model.apiResultPk?.statusCode ?? 200).toString(),
                style: TextStyle(
              ...
              children: [
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Builder(
                      builder: (context) {
                        final pokemon = _model.pokeList.toList();
                        return ListView.builder(
                          padding: EdgeInsets.zero,
                          scrollDirection: Axis.vertical,
                          itemCount: pokemon.length,
                          itemBuilder: (context, pokemonIndex) {
                            final pokemonItem = pokemon[pokemonIndex];
                            return Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Image.network(
                                            pokemonItem.sprites.other.dreamWorld
                                                .frontDefault,
                                            width: 30.0,
                                            height: 30.0,
                                            fit: BoxFit.cover,
                                                      ...
                                                      padding:
                                                          const EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        'Base experience: ${pokemonItem.baseExperience.toString()}',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .labelMedium
