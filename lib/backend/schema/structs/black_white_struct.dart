...
class BlackWhiteStruct extends BaseStruct {
  BlackWhiteStruct({
    AnimatedStruct? animated,
    String? backDefault,
    String? backFemale,
    String? backShiny,
  ...
  // "animated" field.
  AnimatedStruct? _animated;
  AnimatedStruct get animated => _animated ?? AnimatedStruct();
  set animated(AnimatedStruct? val) => _animated = val;
  void updateAnimated(Function(AnimatedStruct) updateFn) =>
      updateFn(_animated ??= AnimatedStruct());
  bool hasAnimated() => _animated != null;
  ...
  static BlackWhiteStruct fromMap(Map<String, dynamic> data) =>
      BlackWhiteStruct(
        animated: AnimatedStruct.maybeFromMap(data['animated']),
  ...
  static BlackWhiteStruct? maybeFromMap(dynamic data) => data is Map
      ? BlackWhiteStruct.fromMap(data.cast<String, dynamic>())
      : null;

  Map<String, dynamic> toMap() => {
        'animated': _animated?.toMap(),
  ...
  static BlackWhiteStruct fromSerializableMap(Map<String, dynamic> data) =>
      BlackWhiteStruct(
        animated: deserializeStructParam(
          data['animated'],
          ParamType.DataStruct,
          false,
          structBuilder: AnimatedStruct.fromSerializableMap,
        ),
  ...
  @override
  String toString() => 'BlackWhiteStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is BlackWhiteStruct &&
...
BlackWhiteStruct createBlackWhiteStruct({
  AnimatedStruct? animated,
  String? backDefault,
  String? backFemale,
  String? backShiny,
  ...
  String? frontShinyFemale,
    ...
    BlackWhiteStruct(
      animated: animated ?? AnimatedStruct(),
