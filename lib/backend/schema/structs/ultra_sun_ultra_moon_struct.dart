...
class UltraSunUltraMoonStruct extends BaseStruct {
  UltraSunUltraMoonStruct({
    String? frontDefault,
    String? frontFemale,
    String? frontShiny,
  ...
  static UltraSunUltraMoonStruct fromMap(Map<String, dynamic> data) =>
      UltraSunUltraMoonStruct(
  ...
  static UltraSunUltraMoonStruct? maybeFromMap(dynamic data) => data is Map
      ? UltraSunUltraMoonStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static UltraSunUltraMoonStruct fromSerializableMap(
  ...
  @override
  String toString() => 'UltraSunUltraMoonStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is UltraSunUltraMoonStruct &&
...
UltraSunUltraMoonStruct createUltraSunUltraMoonStruct({
  String? frontDefault,
  String? frontFemale,
  String? frontShiny,
  String? frontShinyFemale,
