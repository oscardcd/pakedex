...
class DiamondPearlStruct extends BaseStruct {
  DiamondPearlStruct({
    String? backDefault,
    String? backFemale,
    String? backShiny,
  ...
  static DiamondPearlStruct fromMap(Map<String, dynamic> data) =>
      DiamondPearlStruct(
  ...
  static DiamondPearlStruct? maybeFromMap(dynamic data) => data is Map
      ? DiamondPearlStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static DiamondPearlStruct fromSerializableMap(Map<String, dynamic> data) =>
      DiamondPearlStruct(
  ...
  @override
  String toString() => 'DiamondPearlStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is DiamondPearlStruct &&
...
DiamondPearlStruct createDiamondPearlStruct({
  String? backDefault,
  String? backFemale,
  String? backShiny,
  String? backShinyFemale,
