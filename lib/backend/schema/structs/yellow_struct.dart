...
class YellowStruct extends BaseStruct {
  YellowStruct({
    String? backDefault,
    String? backGray,
  ...
  static YellowStruct fromMap(Map<String, dynamic> data) => YellowStruct(
  ...
  static YellowStruct? maybeFromMap(dynamic data) =>
      data is Map ? YellowStruct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  static YellowStruct fromSerializableMap(Map<String, dynamic> data) =>
      YellowStruct(
  ...
  @override
  String toString() => 'YellowStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is YellowStruct &&
...
YellowStruct createYellowStruct({
  String? backDefault,
  String? backGray,
  String? backTransparent,
  String? frontDefault,
