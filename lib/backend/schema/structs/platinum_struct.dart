...
class PlatinumStruct extends BaseStruct {
  PlatinumStruct({
    String? backDefault,
    String? backFemale,
    String? backShiny,
  ...
  static PlatinumStruct fromMap(Map<String, dynamic> data) => PlatinumStruct(
  ...
  static PlatinumStruct? maybeFromMap(dynamic data) =>
      data is Map ? PlatinumStruct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  static PlatinumStruct fromSerializableMap(Map<String, dynamic> data) =>
      PlatinumStruct(
  ...
  @override
  String toString() => 'PlatinumStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is PlatinumStruct &&
...
PlatinumStruct createPlatinumStruct({
  String? backDefault,
  String? backFemale,
  String? backShiny,
  String? backShinyFemale,
