...
class HeartgoldSoulsilverStruct extends BaseStruct {
  HeartgoldSoulsilverStruct({
    String? backDefault,
    String? backFemale,
    String? backShiny,
  ...
  static HeartgoldSoulsilverStruct fromMap(Map<String, dynamic> data) =>
      HeartgoldSoulsilverStruct(
  ...
  static HeartgoldSoulsilverStruct? maybeFromMap(dynamic data) => data is Map
      ? HeartgoldSoulsilverStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static HeartgoldSoulsilverStruct fromSerializableMap(
  ...
  @override
  String toString() => 'HeartgoldSoulsilverStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is HeartgoldSoulsilverStruct &&
...
HeartgoldSoulsilverStruct createHeartgoldSoulsilverStruct({
  String? backDefault,
  String? backFemale,
  String? backShiny,
  String? backShinyFemale,
