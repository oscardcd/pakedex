...
class XYStruct extends BaseStruct {
  XYStruct({
    String? frontDefault,
    String? frontFemale,
    String? frontShiny,
  ...
  static XYStruct fromMap(Map<String, dynamic> data) => XYStruct(
  ...
  static XYStruct? maybeFromMap(dynamic data) =>
      data is Map ? XYStruct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  static XYStruct fromSerializableMap(Map<String, dynamic> data) => XYStruct(
  ...
  @override
  String toString() => 'XYStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is XYStruct &&
