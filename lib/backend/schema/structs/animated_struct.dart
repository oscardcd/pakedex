...
class AnimatedStruct extends BaseStruct {
  AnimatedStruct({
    String? backDefault,
    String? backFemale,
    String? backShiny,
  ...
  static AnimatedStruct fromMap(Map<String, dynamic> data) => AnimatedStruct(
  ...
  static AnimatedStruct? maybeFromMap(dynamic data) =>
      data is Map ? AnimatedStruct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  static AnimatedStruct fromSerializableMap(Map<String, dynamic> data) =>
      AnimatedStruct(
  ...
  @override
  String toString() => 'AnimatedStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is AnimatedStruct &&
...
AnimatedStruct createAnimatedStruct({
  String? backDefault,
  String? backFemale,
  String? backShiny,
  String? backShinyFemale,
